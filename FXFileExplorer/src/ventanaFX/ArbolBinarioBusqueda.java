...
public class ArbolBinarioBusqueda extends ArbolBinario{
	...
	public static void Maximo(Nodo raizSub) throws Exception {
		...
		if (raizSub != null) {
			...
			String subtexto = cortarHastaPunto((String)raizSub.valorNodo());
			if(Integer.parseInt(subtexto)> nuevoNodo) {
				nuevoNodo = Integer.parseInt(subtexto);
			} 
		}	
	
		
	}
	public static String cortarHastaPunto(String texto) {
